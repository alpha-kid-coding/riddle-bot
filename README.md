...
**A browser-based riddle game in python with clues, scoring, timed modes, typo/synonym-friendly answers, and saved reviews/times.**

**Note: You owe me a donut to use this riddle-bot!** 
...
**Run publically** 
* From the project root: `python3 server.py` Then open: [http://127.0.0.1:8767](http://127.0.0.1:8767)
...
- This project is designed for public play.
